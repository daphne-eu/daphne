...
struct DaphneConfigJsonParams {
    ...
    inline static const std::string USE_PHY_OP_SELECTION =
    ...
    inline static const std::string MATMUL_FIXED_TILE_SIZES =
        "matmul_fixed_tile_sizes";
    inline static const std::string MATMUL_USE_FIXED_TILE_SIZES =
        "matmul_use_fixed_tile_sizes";
    inline static const std::string MATMUL_UNROLL_FACTOR =
        "matmul_unroll_factor";
    inline static const std::string MATMUL_UNROLL_JAM_FACTOR =
        "matmul_unroll_jam_factor";
    inline static const std::string MATMUL_NUM_VEC_REGISTERS =
    ...
    inline static const std::string VECTORIZED_SINGLE_QUEUE =
    ...
    inline static const std::string EXPLAIN_PARSING_SIMPLIFIED =
        "explain_parsing_simplified";
    inline static const std::string EXPLAIN_PROPERTY_INFERENCE =
        "explain_property_inference";
    inline static const std::string EXPLAIN_SELECT_MATRIX_REPR =
        "explain_select_matrix_repr";
    inline static const std::string EXPLAIN_SQL = "explain_sql";
    inline static const std::string EXPLAIN_PHY_OP_SELECTION =
        "explain_phy_op_selection";
    inline static const std::string EXPLAIN_TYPE_ADAPTATION =
        "explain_type_adaptation";
    inline static const std::string EXPLAIN_VECTORIZED = "explain_vectorized";
    inline static const std::string EXPLAIN_OBJ_REF_MGNT =
        "explain_obj_ref_mgnt";
    inline static const std::string EXPLAIN_MLIR_CODEGEN =
        "explain_mlir_codegen";
    inline static const std::string TASK_PARTITIONING_SCHEME =
    ...
    inline static const std::string DAPHNEDSL_IMPORT_PATHS =
