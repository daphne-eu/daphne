...
struct DaphneConfigJsonParams {
    ...
    inline static const std::string USE_MLIR_CODEGEN = "use_codegen";
    ...
    inline static const std::string EXPLAIN_MLIR_CODEGEN = "explain_codegen";
    ...
    inline static const std::string JSON_PARAMS[] = {USE_CUDA_,
                                                     USE_VECTORIZED_EXEC,
                                                     USE_OBJ_REF_MGNT,
                                                     USE_IPA_CONST_PROPA,
