...
std::vector<Type> daphne::DuckDbSqlOp::inferTypes() {
//TODO? For now it seems to works like thisr
// throw std::runtime_error("type inference not implemented for DuckDBSQLOp"); // TODO
