...
IMPL_SPLIT_COMBINE_EWBINARYOP(ColumnEqOp)
IMPL_SPLIT_COMBINE_EWBINARYOP(ColumnNeqOp)
IMPL_SPLIT_COMBINE_EWBINARYOP(ColumnLtOp)
IMPL_SPLIT_COMBINE_EWBINARYOP(ColumnLeOp)
IMPL_SPLIT_COMBINE_EWBINARYOP(ColumnGtOp)
IMPL_SPLIT_COMBINE_EWBINARYOP(ColumnGeOp)
