...
template<class ConcreteOp> class SparseIfAllInputSparse : public TraitBase<ConcreteOp, SparseIfAllInputSparse> {};
template<class ConcreteOp> class DenseIfAllInputDense : public TraitBase<ConcreteOp, DenseIfAllInputDense> {};
template<class ConcreteOp> class SparsityRemainsIfAllInputOneOrZero : public TraitBase<ConcreteOp, SparsityRemainsIfAllInputOneOrZero> {};
