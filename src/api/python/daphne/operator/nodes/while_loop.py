...
class WhileLoop(OperationNode):
    def __init__(self, daphne_context: 'DaphneContext', cond: Callable, callback: Callable,
        ...
        """
        Operational node that represents while-loop functionality.
        ...
        # cast the iterable to list for consistency and to avoid addiotnal coping
    ...
    def code_line(self, var_name: str, unnamed_input_vars: Sequence[str],
        ...
        """
        Generates the DaphneDSL code block for while-loop statement.
