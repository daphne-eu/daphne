...
class Matrix(OperationNode):
    ...
    def __init__(self, daphne_context: 'DaphneContext', operation:str, unnamed_input_nodes:Union[str, Iterable[VALID_INPUT_TYPES]]=None, 
                ...
                local_data: np.array = None, brackets:bool = False, left_brackets: bool = False, copy: bool = False)->'Matrix':
        self.__copy = copy
        ...
        if local_data is not None:
            ...
            self._np_array = None
        super().__init__(daphne_context, operation, unnamed_input_nodes, named_input_nodes, OutputType.MATRIX,is_python_local_data, brackets, left_brackets)
    ...
    def __setitem__(self, key, value):
        ...
        #   first create a new_node that is a copy of the current DAG node.
        #   Then, change the state of the current DAG node to an operation for left indexing
