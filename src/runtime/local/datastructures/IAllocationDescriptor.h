...
static std::string_view allocation_types[] = {
    "DIST_GRPC", "DIST_GRPC_ASYNC",  "DIST_GRPC_SYNC", "DIST_MPI", "DIST_SPARK", "GPU_CUDA",       "GPU_HIP",
    "HOST",      "HOST_PINNED_CUDA", "FPGA_INT",       "FPGA_XLX", "ONEAPI",     "NUM_ALLOC_TYPES"};
