...
void ContiguousTensor<ValueType>::printValue(std::ostream &os,
                                             ValueType val) const {
    os << val;
}
...
template <>
[[maybe_unused]] void ContiguousTensor<uint8_t>::printValue(std::ostream &os,
                                                            uint8_t val) const {
    os << static_cast<uint32_t>(val);
}

template <>
[[maybe_unused]] void ContiguousTensor<int8_t>::printValue(std::ostream &os,
                                                           int8_t val) const {
