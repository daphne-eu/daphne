...
template <typename VT> struct ReadCsv<DenseMatrix<VT>> {
    ...
    static void apply(DenseMatrix<VT> *&res, const char *filename, char delim) { readCsvFile(res, filename, delim); }
};
...
template <typename VT> struct ReadCsv<CSRMatrix<VT>> {
    ...
    static void apply(CSRMatrix<VT> *&res, const char *filename, char delim) { readCsvFile(res, filename, delim); }
};
...
template <> struct ReadCsv<Frame> {
    ...
    static void apply(Frame *&res, const char *filename, char delim) { readCsvFile(res, filename, delim); }
};
