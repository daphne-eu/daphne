...
SUPPORT_EQUALITY_RLR(int64_t, FixedStr32, FixedStr32)
SUPPORT_EQUALITY_RLR(int64_t, FixedStr64, FixedStr64)
SUPPORT_EQUALITY_RLR(int64_t, FixedStr128, FixedStr128)
SUPPORT_EQUALITY_RLR(int64_t, FixedStr256, FixedStr256)
SUPPORT_EQUALITY_RLR(int64_t, Umbra_t, Umbra_t)
SUPPORT_EQUALITY_RLR(int64_t, NewUmbra_t, NewUmbra_t)
SUPPORT_EQUALITY_RLR(int64_t, UnorderedDictionaryEncodedString, UnorderedDictionaryEncodedString)
SUPPORT_EQUALITY_RLR(int64_t, OrderedDictionaryEncodedString, OrderedDictionaryEncodedString)
...
SUPPORT_COMPARISONS_RLR(int64_t, FixedStr32, FixedStr32)
SUPPORT_COMPARISONS_RLR(int64_t, FixedStr64, FixedStr64)
SUPPORT_COMPARISONS_RLR(int64_t, FixedStr128, FixedStr128)
SUPPORT_COMPARISONS_RLR(int64_t, FixedStr256, FixedStr256)
SUPPORT_COMPARISONS_RLR(int64_t, Umbra_t, Umbra_t)
SUPPORT_COMPARISONS_RLR(int64_t, NewUmbra_t, NewUmbra_t)
SUPPORT_COMPARISONS_RLR(int64_t, UnorderedDictionaryEncodedString, UnorderedDictionaryEncodedString)
SUPPORT_COMPARISONS_RLR(int64_t, OrderedDictionaryEncodedString, OrderedDictionaryEncodedString)
...
SUPPORT_STRING_RLR(UnorderedDictionaryEncodedString, UnorderedDictionaryEncodedString, UnorderedDictionaryEncodedString)
SUPPORT_STRING_RLR(UnorderedDictionaryEncodedString, UnorderedDictionaryEncodedString, const char *)
SUPPORT_STRING_RLR(OrderedDictionaryEncodedString, OrderedDictionaryEncodedString, OrderedDictionaryEncodedString)
SUPPORT_STRING_RLR(OrderedDictionaryEncodedString, OrderedDictionaryEncodedString, const char *)
