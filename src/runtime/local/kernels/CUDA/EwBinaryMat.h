...
namespace CUDA {
    ...
    struct EwBinaryMat<DenseMatrix<VTres>, DenseMatrix<VTlhs>, DenseMatrix<VTrhs>> {
        static void apply(BinaryOpCode opCode, DenseMatrix<VTres> *&res, DenseMatrix<VTlhs> *lhs,
                          DenseMatrix<VTrhs> *rhs, bool hasFutureUseLhs, bool hasFutureUseRhs, DCTX(ctx));
    };
