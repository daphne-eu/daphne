...
template <class DTResPos, class DTLhsData, typename VTRhsData> struct ColSelectCmp {
    static void apply(CmpOpCode opCode, DTResPos *&resPos, const DTLhsData *lhsData, VTRhsData rhsData,
                      DCTX(ctx)) = delete;
};
...
template <typename VTPos, typename VTLhsData, typename VTRhsData>
struct ColSelectCmp<Column<VTPos>, Column<VTLhsData>, VTRhsData> {
    static void apply(CmpOpCode opCode, Column<VTPos> *&resPos, const Column<VTLhsData> *lhsData, VTRhsData rhsData,
                      DCTX(ctx)) {
