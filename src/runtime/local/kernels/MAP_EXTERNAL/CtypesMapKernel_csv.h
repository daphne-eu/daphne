...
#ifndef SRC_RUNTIME_LOCAL_KERNELS_MAP_EXTERNAL_CSVMAPKERNEL_H
#define SRC_RUNTIME_LOCAL_KERNELS_MAP_EXTERNAL_CSVMAPKERNEL_H
...
#endif //SRC_RUNTIME_LOCAL_KERNELS_MAP_EXTERNAL_CSVMAPKERNEL_H