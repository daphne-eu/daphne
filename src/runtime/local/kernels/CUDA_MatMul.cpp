...
template struct MatMul_CUDA<CSRMatrix<float>, CSRMatrix<float>, CSRMatrix<float>>;
template struct MatMul_CUDA<CSRMatrix<double>, CSRMatrix<double>, CSRMatrix<double>>;
