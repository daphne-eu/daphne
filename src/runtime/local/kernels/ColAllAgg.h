...
template <class DTRes, class DTArg> struct ColAllAgg {
...
template <class DTRes, class DTArg> void colAllAgg(AggOpCode opCode, DTRes *&res, const DTArg *arg, DCTX(ctx)) {
    ColAllAgg<DTRes, DTArg>::apply(opCode, res, arg, ctx);
}
...
template <typename VTRes, typename VTArg> struct ColAllAgg<Column<VTRes>, Column<VTArg>> {
