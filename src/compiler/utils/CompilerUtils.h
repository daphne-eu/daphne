 ...
 */
 ...
 struct CompilerUtils {
   ...
   public:
     ...
     static std::string mlirTypeToCppTypeName(mlir::Type t, bool angleBrackets = true,
         ...
         if (t.isF64())
             ...
             if (generalizeToStructure)
                 ...
                 // special case in the future.
                 std::string vtName;
                 if (colTy.getColumnType().isa<mlir::daphne::StringType>())
                     vtName = "std::string";
                 else
                     vtName = mlirTypeToCppTypeName(colTy.getColumnType(), angleBrackets, false);
     ...
     /**
      * @brief Returns `true` if the given type is a DAPHNE data object (i.e., a matrix, frame, column, or list); or
      * `false`, otherwise.
      */
     ...
     /**
      * @brief Returns `true` if the given value is a DAPHNE data object (i.e., a matrix, frame, column, or list); or
      * `false`, otherwise.
      */
     ...
     /**
      * @brief Returns `true` if the given type is a DAPHNE scalar; or `false`, otherwise.
      */
