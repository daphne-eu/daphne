...
CompilerUtils::isConstantHelper<std::string, mlir::StringAttr>(
    mlir::Value v,
    const std::function<std::string(const mlir::StringAttr &)> &func) {
...
template <>
std::pair<bool, std::string>
CompilerUtils::isConstant<std::string>(mlir::Value v) {
...
std::pair<bool, float> CompilerUtils::isConstant<float>(mlir::Value v) {
    return isConstantHelper<float, mlir::FloatAttr>(
        v,
        [](mlir::FloatAttr attr) { return attr.getValue().convertToFloat(); });
}
...
std::pair<bool, double> CompilerUtils::isConstant<double>(mlir::Value v) {
    return isConstantHelper<double, mlir::FloatAttr>(
        v,
        [](mlir::FloatAttr attr) { return attr.getValue().convertToDouble(); });
}
...
template <>
std::string
CompilerUtils::constantOrThrow<std::string>(mlir::Value v,
...
template <>
int64_t CompilerUtils::constantOrThrow<int64_t>(mlir::Value v,
                                                const std::string &errorMsg) {
...
template <>
uint64_t CompilerUtils::constantOrThrow<uint64_t>(mlir::Value v,
                                                  const std::string &errorMsg) {
...
template <>
float CompilerUtils::constantOrThrow<float>(mlir::Value v,
                                            const std::string &errorMsg) {
...
template <>
double CompilerUtils::constantOrThrow<double>(mlir::Value v,
                                              const std::string &errorMsg) {
...
template <>
bool CompilerUtils::constantOrThrow<bool>(mlir::Value v,
                                          const std::string &errorMsg) {
    return constantOrThrowHelper<bool, mlir::BoolAttr>(
        v, [](mlir::BoolAttr attr) { return attr.getValue(); }, errorMsg,
        "bool");
}
...
template <>
std::string CompilerUtils::constantOrDefault<std::string>(mlir::Value v,
                                                          std::string d) {
...
[[maybe_unused]] FileMetaData
CompilerUtils::getFileMetaData(mlir::Value filename) {
...
bool CompilerUtils::isMatrixComputation(mlir::Operation *v) {
    return llvm::any_of(v->getOperandTypes(),
                        [&](mlir::Type ty) {
                            return llvm::isa<mlir::daphne::MatrixType>(ty);
                        }) ||
