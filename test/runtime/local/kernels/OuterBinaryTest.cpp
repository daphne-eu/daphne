...
template <class DT>
void checkOuterBinary(BinaryOpCode opCode, const DT *lhs, const DT *rhs,
                      const DT *exp) {
    DT *res = nullptr;
...
template <class DT>
void helper(BinaryOpCode opCode, std::vector<typename DT::VT> lhsVals,
            std::vector<typename DT::VT> rhsVals,
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("valid shapes"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    using DT = TestType;
    ...
    SECTION("0x1 op 1x0") {
        ...
        rhs =
            static_cast<DT *>(DataObjectFactory::create<DTEmpty>(1, 0, false));
        exp =
            static_cast<DT *>(DataObjectFactory::create<DTEmpty>(0, 0, false));
    }
    SECTION("0x1 op 1xn") {
        lhs =
            static_cast<DT *>(DataObjectFactory::create<DTEmpty>(0, 1, false));
        ...
        exp =
            static_cast<DT *>(DataObjectFactory::create<DTEmpty>(0, 4, false));
    }
    SECTION("mx1 op 1x0") {
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("invalid shapes"), TAG_KERNELS,
    ...
    DT *res = nullptr;
    CHECK_THROWS(
        outerBinary<DT, DT, DT>(BinaryOpCode::ADD, res, lhs, rhs, nullptr));
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("sub"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("div"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::DIV, {6, 4}, {2}, {3, 2});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("pow"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::POW, {1, 2}, {3}, {1, 8});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("mod"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::MOD, {7, 2}, {3}, {1, 2});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("log"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("min"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::MIN, {1, 3}, {2}, {1, 2});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("max"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("and"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::AND, {1, 0}, {1}, {1, 0});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("or"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("eq"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::EQ, {1, 2}, {2}, {0, 1});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("neq"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::NEQ, {1, 2}, {2}, {1, 0});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("lt"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::LT, {1, 2}, {2}, {1, 0});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("le"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::LE, {1, 2}, {2}, {1, 1});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("gt"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
    helper<TestType>(BinaryOpCode::GT, {1, 2}, {2}, {0, 0});
}

TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("ge"), TAG_KERNELS, (DATA_TYPES),
                           (VALUE_TYPES)) {
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("some invalid op-code"), TAG_KERNELS,
    ...
    CHECK_THROWS(outerBinary<DT, DT, DT>(static_cast<BinaryOpCode>(999), res, m,
                                         m, nullptr));
}