...
TEMPLATE_PRODUCT_TEST_CASE("CheckEq, views on matrices", TAG_KERNELS,
    ...
    SECTION("same inst") {
        auto view1 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 0, 2, 0, 2));
        CHECK(*view1 == *view1);
    ...
    SECTION("diff inst, same size, same cont, same orig") {
        ...
        auto view2 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 0, 2, 0, 2));
        auto view3 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 1, 3, 4, 6));
        CHECK(*view1 == *view2);
        CHECK(*view1 == *view3);
    ...
    SECTION("diff inst, same size, same cont, diff orig") {
        ...
        auto view1 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 0, 2, 0, 2));
        auto view2 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig2, 0, 2, 0, 2));
        auto view3 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig2, 1, 3, 4, 6));
        CHECK(*view1 == *view2);
        CHECK(*view1 == *view3);
    ...
    SECTION("diff inst, same size, same cont, overlap") {
        auto view1 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 0, 2, 1, 3));
        auto view2 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 0, 2, 2, 4));
        CHECK(*view1 == *view2);
    ...
    SECTION("diff inst, same size, diff cont") {
        auto view1 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 0, 2, 0, 2));
        auto view2 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 4, 6, 4, 6));
    ...
    SECTION("diff inst, diff size, diff cont") {
        auto view1 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 0, 2, 0, 2));
        auto view2 = static_cast<DT *>(
            DataObjectFactory::create<DTGenView>(orig1, 0, 3, 0, 2));
        CHECK_FALSE(*view1 == *view2);
        DataObjectFactory::destroy(view1, view2);
    }
...
TEMPLATE_PRODUCT_TEST_CASE("CheckEq, empty matrices", TAG_KERNELS,
    ...
    SECTION("view, diff inst, same size") {
        auto view1 = static_cast<DT *>(
            DataObjectFactory::create<DTGen>(orig1, 0, 2, 0, 4));
        auto view2 = static_cast<DT *>(
            DataObjectFactory::create<DTGen>(orig1, 1, 3, 0, 4));
        CHECK(*view1 == *view2);
        DataObjectFactory::destroy(view1, view2);
    }
    SECTION("view, diff inst, diff size") {
        auto view1 = static_cast<DT *>(
            DataObjectFactory::create<DTGen>(orig1, 0, 1, 0, 4));
        auto view2 = static_cast<DT *>(
            DataObjectFactory::create<DTGen>(orig1, 1, 3, 0, 4));
        CHECK_FALSE(*view1 == *view2);
        DataObjectFactory::destroy(view1, view2);
