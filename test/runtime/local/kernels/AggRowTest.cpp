...
#define SUM_TEST_CASE(VTRes)                                                   \
    TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("sum - result value type: " #VTRes),  \
        ...
        using DTRes = typename std::conditional<                               \
            ...
            Matrix<VTRes>, DenseMatrix<VTRes>>::type;                          \
                                                                               \
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("min"), TAG_KERNELS, (DATA_TYPES),
    ...
    using DTRes =
        typename std::conditional<std::is_same<DTArg, Matrix<VT>>::value,
...
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("idxmin"), TAG_KERNELS, (DenseMatrix),
                           (VALUE_TYPES)) {
    using DTArg = TestType;
    using VT = typename DTArg::VT;
    using DTRes =
...
// The value type of the result can be assumed to be size_t.
TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("idxmax"), TAG_KERNELS, (DenseMatrix),
                           (VALUE_TYPES)) {
    using DTArg = TestType;
    using VT = typename DTArg::VT;
    using DTRes =
...
#define MEAN_TEST_CASE(VTRes)                                                  \
    TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("mean - result value type: " #VTRes), \
                               TAG_KERNELS, (DATA_TYPES), (VALUE_TYPES)) {     \
        using DTArg = TestType;                                                \
        using DTRes = typename std::conditional<                               \
            std::is_same<DTArg, Matrix<typename DTArg::VT>>::value,            \
        ...
        auto m3exp =                                                           \
            genGivenVals<DTRes>(3, {(VTRes)5.5, (VTRes)3.75, (VTRes)4.25});    \
                                                                               \
        ...
        checkAggRow(AggOpCode::MEAN, m3, m3exp);                               \
                                                                               \
        DataObjectFactory::destroy(m0, m0exp, m1, m1exp, m2, m2exp, m3,        \
                                   m3exp);                                     \
    }
...
#define STDDEV_TEST_CASE(VTRes)                                                \
    TEMPLATE_PRODUCT_TEST_CASE(                                                \
        TEST_NAME("stddev - result value type: " #VTRes), TAG_KERNELS,         \
        ...
        auto m1exp = genGivenVals<DTRes>(3, {(VTRes)3.3166247903553998491,     \
                                             (VTRes)1.7320508075688772935,     \
                                             (VTRes)3.0310889132455352637});   \
        auto m2 = genGivenVals<DTArg>(3, {                                     \
                                             5,                                \
                                             7,                                \
                                             3,                                \
        ...
        auto m2exp = genGivenVals<DTRes>(3, {(VTRes)2.2360679774997896964,     \
                                             (VTRes)1.8708286933869706928,     \
                                             (VTRes)1.2247448713915890491});   \
                                                                               \
...
#define VAR_TEST_CASE(VTRes)                                                   \
    TEMPLATE_PRODUCT_TEST_CASE(TEST_NAME("var - result value type: " #VTRes),  \
                               TAG_KERNELS, (DATA_TYPES), (VALUE_TYPES)) {     \
        using DTArg = TestType;                                                \
        using DTRes = typename std::conditional<                               \
            std::is_same<DTArg, Matrix<typename DTArg::VT>>::value,            \
