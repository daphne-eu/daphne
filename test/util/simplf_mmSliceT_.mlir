...
// CHECK: %[[ROW:.*]] = "daphne.sliceCol"(%[[X]], {{.*}}, {{.*}}) : (!daphne.Matrix<4x6xf64>, si64, si64) -> !daphne.Unknown
// CHECK: %[[COL:.*]] = "daphne.sliceCol"(%[[Y]], {{.*}}, {{.*}}) : (!daphne.Matrix<6x5xf64>, si64, si64) -> !daphne.Unknown
