...
module {
  func.func @main() {
    ...
    %2 = "daphne.constant"() {value = 0.0 : f64} : () -> f64
    %3 = "daphne.constant"() {value = 8.0 : f64} : () -> f64
    ...
    %9 = "daphne.randMatrix"(%7, %8, %2, %3, %4, %6) : (index, index, f64, f64, f64, si64) -> !daphne.Matrix<?x?xf64>
    %10 = "daphne.constant"() {value = 2 : si64} : () -> si64
    %11 = "daphne.ewDiv"(%9, %10) : (!daphne.Matrix<?x?xf64>, si64) -> !daphne.Matrix<?x?xf64>
