...
TEST_CASE("matmul accuracy", "[codegen][matmul]") {
    ...
    compareDaphneToStringNumerically(result, dirPath + "matmul128.daphne", 1, epsilon, "--codegen");
    compareDaphneToStringNumerically(result, dirPath + "matmul128.daphne", 1, epsilon, "--codegen",
...
TEST_CASE("matmul accuracy 576", "[codegen][matmul]") {
    ...
    compareDaphneToStringNumerically(kernel.str(), dirPath + "matmul576.daphne", 1, epsilon, "--codegen",
                                     "--matmul-fixed-tile-sizes=2,3,4,5,6");
}
