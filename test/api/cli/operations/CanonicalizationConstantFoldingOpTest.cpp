...
void compareDaphneParsingSimplifiedToRef(const std::string &refFilePath,
...
TEST_CASE("binary_operator_casts_constant_folding",
          TAG_CODEGEN TAG_OPERATIONS) {
